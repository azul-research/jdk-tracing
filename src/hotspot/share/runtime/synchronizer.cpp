...
#define HOTSPOT_MONITOR_PROBE_notify HOTSPOT_MONITOR_NOTIFY_WRAPPER
#define HOTSPOT_MONITOR_PROBE_notifyAll HOTSPOT_MONITOR_NOTIFY_WRAPPERALL
#define HOTSPOT_MONITOR_PROBE_waited HOTSPOT_MONITOR_WAIT_WRAPPERED
